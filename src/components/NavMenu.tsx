...
export default function NavMenu(props: NavMenuProps) {
	...
	return (
		<>
			<div ref={container} className="fixed h-screen w-full overflow-x-hidden">
				<ul className='w-full h-full uppercase flex flex-col justify-center items-center text-6xl gap-20 relative z-10 text-white'>
